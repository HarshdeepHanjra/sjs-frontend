...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        scrolled ? 'bg-white shadow-md py-1' : 'bg-white shadow-sm py-1'
      }`}>
  ...
  <img
    src="https://res.cloudinary.com/dxxpeilta/image/upload/v1782199022/logo_nsuaue.png"
    alt="SJS Global Tech"
  ...
  />
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 bg-[#FF7A00] hover:bg-[#e66e00] text-white px-3 py-1.5 rounded-lg transition text-sm"
              >
